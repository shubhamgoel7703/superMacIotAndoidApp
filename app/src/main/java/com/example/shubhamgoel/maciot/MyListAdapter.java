...
public class MyListAdapter extends ArrayAdapter<Object> {
    ...
    public MyListAdapter(Context context, int resource, List<Object> heroList) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Object hero = heroList.get(position);

        //adding values to the list item
        textViewName.setText(hero.getdesc());
        textViewTeam.setText(hero.getvalue());
        textViewUnit.setText(hero.getUnit());
